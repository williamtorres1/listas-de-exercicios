...
{
	/*
	A Companhia de Carros Usados Joao Honesto paga a seus funcionarios um salario 
		de R$ 800,00 por mes mais uma comissao de R$ 100,00 por carro vendido
		e mais 5% do valor total de suas vendas. Calcular o salario total de um
		vendedor em um dado mes.
	*/
