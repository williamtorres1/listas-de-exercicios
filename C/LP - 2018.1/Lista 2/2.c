...
{
	/*
		Num dia de sol, voce deseja medir a altura de um predio, porem, a 
			trena nao e suficientemente longa.
		Assumindo que seja possivel medir sua altura, sua sombra e a sombra do 
			predio no chao, calcule a altura do predio.
	*/
