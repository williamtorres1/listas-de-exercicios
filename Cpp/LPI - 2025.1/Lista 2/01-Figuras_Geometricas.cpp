...
/*
  A classe abstrata FiguraGeometrica possui o atributo protected tipo, e 
    possui os seguintes métodos:

    FiguraGeometrica(int tipo).
      Construtor que recebe como parâmetro o tipo e inicia seu atributo.
    float calcularArea(). Abstrato (virtual puro).
      Calcula a área de acordo com a figura geométrica.
    void lerAtributosArea(). Abstrato (virtual puro).
      Lê da entrada padrão os atributos relacionados a área.
    std::string getNome().
      Retorna o nome da figura geométrica.

  Considere que tipo é um valor numérico, onde os seguintes valores possuem os seguintes
    significados:
  ...
  Adicione a essas classes os atributos que forem necessários para o cálculo de sua área.
  Implemente os seguintes métodos:
    Construtor(). 
      Chame o construtor da superclasse dentro desse construtor, e passe como
        parâmetro o tipo da figura em questão.
    float calcularArea().
      Sobrescreva e o implemente de acordo com o tipo da figura geométrica.
    void lerAtributosArea().
      Sobrescreva para ler os atributos específicos da figura em questão.

  Na função principal, declare um ponteiro para FiguraGeométrica, leia o tipo, em
    seguida, instancie a figura geométrica correspondente ao tipo (usando polimorfismo
      no ponteiro declarado).
